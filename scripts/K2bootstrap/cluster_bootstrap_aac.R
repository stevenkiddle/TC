...
aac_cluster_boot <- tempClusterBoot(data = mmse_aac@mat_data,tps=mmse_aac@mat_tps,numSamples = 5,cohort=mmse_aac@cohort,fix_first = T)

save(aac_cluster_boot,file=paste("aac_boot_1_",num,".RData",sep=""))

aac_cluster_boot <- tempClusterBoot(data = mmse_aac@mat_data,tps=mmse_aac@mat_tps,numSamples = 5,cohort=mmse_aac@cohort,fix_first = T)

save(aac_cluster_boot,file=paste("aac_boot_2_",num,".RData",sep=""))